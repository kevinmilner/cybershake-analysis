# RSQSim 4860 10x LAF Hazard Curves
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 1000yr | 0.17951798 | 0.20112172 | 0.12421649 | 0.11060324 | 0.08046278 | 0.07025098 | 0.041951116 | 0.04981405 |
| 2500yr | 0.24961837 | 0.2904129 | 0.15723027 | 0.15895292 | 0.101933695 | 0.098011315 | 0.053531278 | 0.06823515 |
| 10000yr | 0.3281979 | 0.46944577 | 0.20040879 | 0.25534213 | 0.1343708 | 0.15219966 | 0.07573921 | 0.10331695 |
| RTGM | 0.22025444 | 0.26224703 | 0.15549031 | 0.1359424 | 0.10147314 | 0.06818977 | 0.053477675 | 0.02925307 |
...
| **1000yr** | ![Hazard Spectra](resources/LAF_spectra_ASK2014_1000yr.png) |
|-----|-----|
| **2500yr** | ![Hazard Spectra](resources/LAF_spectra_ASK2014_2500yr.png) |
| **10000yr** | ![Hazard Spectra](resources/LAF_spectra_ASK2014_10000yr.png) |
...
|-----|-----|-----|
| 1000yr | ![Hazard Spectra](resources/LAF_spectra_ASK2014_source_contrib_1000yr_sim.png) | ![Hazard Spectra](resources/LAF_spectra_ASK2014_source_contrib_1000yr_gmpe.png) |
| 2500yr | ![Hazard Spectra](resources/LAF_spectra_ASK2014_source_contrib_2500yr_sim.png) | ![Hazard Spectra](resources/LAF_spectra_ASK2014_source_contrib_2500yr_gmpe.png) |
| 10000yr | ![Hazard Spectra](resources/LAF_spectra_ASK2014_source_contrib_10000yr_sim.png) | ![Hazard Spectra](resources/LAF_spectra_ASK2014_source_contrib_10000yr_gmpe.png) |
...
![Hazard Curve](resources/LAF_curves_3.0s_ASK2014.png)
...
![Hazard Curve](resources/LAF_curves_3.0s_ASK2014_gmpe_sims.png)
...
|-----|-----|
| ![Hazard Curve](resources/LAF_curves_3.0s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/LAF_curves_3.0s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/LAF_curves_3.0s_ASK2014_animation.gif)

### 5s Hazard Curves
*[(top)](#table-of-contents)*

![Hazard Curve](resources/LAF_curves_5.0s_ASK2014.png)
...
![Hazard Curve](resources/LAF_curves_5.0s_ASK2014_gmpe_sims.png)
...
| **Simulation Source Contributions** | **GMPE Source Contributions** |
|-----|-----|
| ![Hazard Curve](resources/LAF_curves_5.0s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/LAF_curves_5.0s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/LAF_curves_5.0s_ASK2014_animation.gif)

### 7.5s Hazard Curves
*[(top)](#table-of-contents)*

![Hazard Curve](resources/LAF_curves_7.5s_ASK2014.png)
...
![Hazard Curve](resources/LAF_curves_7.5s_ASK2014_gmpe_sims.png)
...
| **Simulation Source Contributions** | **GMPE Source Contributions** |
|-----|-----|
| ![Hazard Curve](resources/LAF_curves_7.5s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/LAF_curves_7.5s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/LAF_curves_7.5s_ASK2014_animation.gif)

### 10s Hazard Curves
*[(top)](#table-of-contents)*

![Hazard Curve](resources/LAF_curves_10.0s_ASK2014.png)
...
![Hazard Curve](resources/LAF_curves_10.0s_ASK2014_gmpe_sims.png)
...
| **Simulation Source Contributions** | **GMPE Source Contributions** |
|-----|-----|
| ![Hazard Curve](resources/LAF_curves_10.0s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/LAF_curves_10.0s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/LAF_curves_10.0s_ASK2014_animation.gif)
...
| **Disagg Level** | **CyberShake w/ GMPE dist for Epsilon** | **Abrahamson, Silva & Kamai (2014)** |
|-----|-----|-----|
| **2342 yr<br>0.15530984 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_5s_intersect_0.15530984.png) | ![Disaggregation](resources/disagg_gmpe_5s_intersect_0.15530984.png) |
...
| **Disagg Level** | **CyberShake w/ GMPE dist for Epsilon** | **Abrahamson, Silva & Kamai (2014)** |
|-----|-----|-----|
| **3391 yr<br>0.10879083 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_7.5s_intersect_0.10879083.png) | ![Disaggregation](resources/disagg_gmpe_7.5s_intersect_0.10879083.png) |
...
| **Disagg Level** | **CyberShake w/ GMPE dist for Epsilon** | **Abrahamson, Silva & Kamai (2014)** |
|-----|-----|-----|
| **191 yr<br>0.024795432 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_10s_intersect_0.024795432.png) | ![Disaggregation](resources/disagg_gmpe_10s_intersect_0.024795432.png) |
