# RSQSim 4860 10x SMCA Hazard Curves
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| 1000yr | 0.22028798 | 0.19841452 | 0.13327779 | 0.10853768 | 0.07766362 | 0.06937074 | 0.04052224 | 0.049367454 |
| 2500yr | 0.30456895 | 0.28189415 | 0.16997218 | 0.15336105 | 0.10795917 | 0.09567927 | 0.05251744 | 0.067176305 |
| 10000yr | 0.38256568 | 0.4487366 | 0.21584164 | 0.24264543 | 0.14587523 | 0.14664735 | 0.07144214 | 0.100875854 |
| RTGM | 0.25812715 | 0.25631437 | 0.1593593 | 0.13095558 | 0.09758688 | 0.06489315 | 0.049565326 | 0.027689876 |
...
| **1000yr** | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_1000yr.png) |
|-----|-----|
| **2500yr** | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_2500yr.png) |
| **10000yr** | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_10000yr.png) |
...
|-----|-----|-----|
| 1000yr | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_source_contrib_1000yr_sim.png) | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_source_contrib_1000yr_gmpe.png) |
| 2500yr | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_source_contrib_2500yr_sim.png) | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_source_contrib_2500yr_gmpe.png) |
| 10000yr | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_source_contrib_10000yr_sim.png) | ![Hazard Spectra](resources/SMCA_spectra_ASK2014_source_contrib_10000yr_gmpe.png) |
...
![Hazard Curve](resources/SMCA_curves_3.0s_ASK2014.png)
...
![Hazard Curve](resources/SMCA_curves_3.0s_ASK2014_gmpe_sims.png)
...
|-----|-----|
| ![Hazard Curve](resources/SMCA_curves_3.0s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/SMCA_curves_3.0s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/SMCA_curves_3.0s_ASK2014_animation.gif)

### 5s Hazard Curves
*[(top)](#table-of-contents)*

![Hazard Curve](resources/SMCA_curves_5.0s_ASK2014.png)
...
![Hazard Curve](resources/SMCA_curves_5.0s_ASK2014_gmpe_sims.png)
...
| **Simulation Source Contributions** | **GMPE Source Contributions** |
|-----|-----|
| ![Hazard Curve](resources/SMCA_curves_5.0s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/SMCA_curves_5.0s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/SMCA_curves_5.0s_ASK2014_animation.gif)

### 7.5s Hazard Curves
*[(top)](#table-of-contents)*

![Hazard Curve](resources/SMCA_curves_7.5s_ASK2014.png)
...
![Hazard Curve](resources/SMCA_curves_7.5s_ASK2014_gmpe_sims.png)
...
| **Simulation Source Contributions** | **GMPE Source Contributions** |
|-----|-----|
| ![Hazard Curve](resources/SMCA_curves_7.5s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/SMCA_curves_7.5s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/SMCA_curves_7.5s_ASK2014_animation.gif)

### 10s Hazard Curves
*[(top)](#table-of-contents)*

![Hazard Curve](resources/SMCA_curves_10.0s_ASK2014.png)
...
![Hazard Curve](resources/SMCA_curves_10.0s_ASK2014_gmpe_sims.png)
...
| **Simulation Source Contributions** | **GMPE Source Contributions** |
|-----|-----|
| ![Hazard Curve](resources/SMCA_curves_10.0s_ASK2014_source_contrib_sim.png) | ![Hazard Curve](resources/SMCA_curves_10.0s_ASK2014_source_contrib_gmpe.png) |
...
![Hazard Curve Animation](resources/SMCA_curves_10.0s_ASK2014_animation.gif)
...
|-----|-----|-----|
| **458 yr<br>0.14235875 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_3s_intersect_0.14235875.png) | ![Disaggregation](resources/disagg_gmpe_3s_intersect_0.14235875.png) |
| **4146 yr<br>0.33703443 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_3s_intersect_0.33703443.png) | ![Disaggregation](resources/disagg_gmpe_3s_intersect_0.33703443.png) |
...
| **Disagg Level** | **CyberShake w/ GMPE dist for Epsilon** | **Abrahamson, Silva & Kamai (2014)** |
|-----|-----|-----|
| **5279 yr<br>0.19825412 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_5s_intersect_0.19825412.png) | ![Disaggregation](resources/disagg_gmpe_5s_intersect_0.19825412.png) |
...
| **Disagg Level** | **CyberShake w/ GMPE dist for Epsilon** | **Abrahamson, Silva & Kamai (2014)** |
|-----|-----|-----|
| **9858 yr<br>0.14630525 g** | ![Disaggregation](resources/disagg_sim_gmpe_dist_for_epsilon_7.5s_intersect_0.14630525.png) | ![Disaggregation](resources/disagg_gmpe_7.5s_intersect_0.14630525.png) |
