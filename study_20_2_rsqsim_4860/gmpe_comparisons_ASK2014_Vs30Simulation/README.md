# RSQSim 4860/ASK2014 GMPE Comparisons
...
|-----|-----|-----|-----|-----|-----|
| USC | *34.0192, -118.286* | 3455 (3455 sims) | 500 | 0.58 | 4.1 |

3455 ruptures within 200 km of *any* site
#### All Sites, 6 < Mw < 6.5
0 Ruptures
...
**Legend**
* Red +: GMPE Mean/RSQSim 4860 single rupture comparison
...
These plots compare RSQSim 4860 to the full GMPE log-normal distributions. Each rupture's GMPE distribution is converted to a standard log-normal distribution, and the z-score is computed for each rupture:

**z-score**: (ln(*RSQSim 4860*) - ln(*GMPE-mean*)) / *GMPE-sigma*

**Legend**
* Black Line: Standard Normal distribution (in natural log space)
* Gray Histogram: z-score for each rupture
* Blue Dashed Line: RSQSim 4860 Mean
...
Residuals of simulation data (RSQSim 4860) in log space relative to GMPE log-mean
