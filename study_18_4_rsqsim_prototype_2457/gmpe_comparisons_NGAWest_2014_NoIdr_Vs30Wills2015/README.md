# RSQSim 2457/NGAWest_2014_NoIdr GMPE Comparisons
...
|-----|-----|-----|-----|-----|-----|
| USC | *34.0192, -118.286* | 15832 (15832 sims) | 293.5 | 0.6 | 4.05 |

15832 ruptures within 200 km of *any* site
#### All Sites, 6 < Mw < 6.5
0 Ruptures
...
**Legend**
* Red +: GMPE Mean/RSQSim 2457 single rupture comparison
...
These plots compare RSQSim 2457 to the full GMPE log-normal distributions. Each rupture's GMPE distribution is converted to a standard log-normal distribution, and the z-score is computed for each rupture:

**z-score**: (ln(*RSQSim 2457*) - ln(*GMPE-mean*)) / *GMPE-sigma*

**Legend**
* Black Line: Standard Normal distribution (in natural log space)
* Gray Histogram: z-score for each rupture
* Blue Dashed Line: RSQSim 2457 Mean
...
Residuals of simulation data (RSQSim 2457) in log space relative to GMPE log-mean
